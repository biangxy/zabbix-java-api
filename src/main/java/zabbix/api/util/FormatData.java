...
public class FormatData {
    ...
    public static String API_URL ="http://10.1.5.25/zabbix/api_jsonrpc.php" ;//"http://192.168.0.198/ywgunicloudsh/api_jsonrpc.php"; // API的连接，在接口中给它赋值
...
//            return response;
            ...
            return resp.getEntity().getContent().toString();
