...
public class ActionOperation
{
    ...
    /**
     * 操作类型（0 - send message;1 - remote command;2 - add host;
     * 3 - remove host;4 - add to host group;
     * 5 - remove from host group;6 - link to template;
     * 7 - unlink from template;8 - enable host;9 - disable host.）
     */
     ...
     * 远程命令操作
     */
    private ActionOperationCommand opcommand;
    /**
     * 以设备组运行远程命令操作
     */
     ...
     * 触发动作的操作条件
     */
    private List<ActionOperationCondition> opconditions;
    /**
     * 设备组
     */
