...
public class Action
{
    ...
    /**
     * required 默认操作步骤停留时间(必须大于60秒) Default operation step duration
     */
    private Integer esc_period;
    /**
     * required 计算方式        0 - AND / OR;1 - AND;2 - OR. 默认配置0
     */
    private Integer evaltype;
    /**
     * required 发生事件的类型（event source）0 - event created by a trigger;默认选择此项
    ...
    private String name;
    /**
     * 动作触发的消息        Default message
     */
    private String def_longdata;
    /**
     * 动作触发的标题        Default subject
     */
    private String def_shortdata;
    /**
     * 动作恢复的消息        Recovery message
     */
    private String r_longdata;
    /**
     * 动作恢复的标题        Recovery subject
     */
